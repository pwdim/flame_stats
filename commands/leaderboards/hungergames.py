...
class HGLeaderboards(commands.Cog):
    def __init__(self, bot):
        ...
        self.original_interaction_for_edit = None
        self.current_stat_id = "19"
        self.current_period = "total"

        self.stat_info = {
            "total": {
                "21": {"name": "Vitórias", "stat_key": "hg_wins", "emoji": "<a:wins:1348790119070564402>", "endpoint_suffix": "", "data_key": "accountStats"},
                "22": {"name": "Abates", "stat_key": "hg_kills", "emoji": "<a:abates:1348799859603406979>", "endpoint_suffix": "", "data_key": "accountStats"},
                "23": {"name": "Mortes", "stat_key": "hg_deaths", "emoji": "<a:skull:1348799160979030096>", "endpoint_suffix": "", "data_key": "accountStats"},
                "19": {"name": "XP", "stat_key": "hg_exp", "emoji": "<a:xp:1348792513300795504>", "endpoint_suffix": "", "data_key": "accountStats"},
            },
            "monthly": {
                "21": {"name": "Vitórias", "stat_key": "hg_wins", "emoji": "<a:wins:1348790119070564402>", "endpoint_suffix": "/monthly", "data_key": "accountStatsMonthly"},
                "22": {"name": "Abates", "stat_key": "hg_kills", "emoji": "<a:abates:1348799859603406979>", "endpoint_suffix": "/monthly", "data_key": "accountStatsMonthly"},
                "23": {"name": "Mortes", "stat_key": "hg_deaths", "emoji": "<a:skull:1348799160979030096>", "endpoint_suffix": "/monthly", "data_key": "accountStatsMonthly"},
                "19": {"name": "XP", "stat_key": "hg_exp", "emoji": "<a:xp:1348792513300795504>", "endpoint_suffix": "/monthly", "data_key": "accountStatsMonthly"},
            },
            "weekly": {
                "21": {"name": "Vitórias", "stat_key": "hg_wins", "emoji": "<a:wins:1348790119070564402>", "endpoint_suffix": "/weekly", "data_key": "accountStatsWeekly"},
                "22": {"name": "Abates", "stat_key": "hg_kills", "emoji": "<a:abates:1348799859603406979>", "endpoint_suffix": "/weekly", "data_key": "accountStatsWeekly"},
                "23": {"name": "Mortes", "stat_key": "hg_deaths", "emoji": "<a:skull:1348799160979030096>", "endpoint_suffix": "/weekly", "data_key": "accountStatsWeekly"},
                "19": {"name": "XP", "stat_key": "hg_exp", "emoji": "<a:xp:1348792513300795504>", "endpoint_suffix": "/weekly", "data_key": "accountStatsWeekly"},
            },
        }

    hg = app_commands.Group(name="hg", description="Exibe as classificações de Hunger Games do FlameMC.")
    ...
    async def fetch_leaderboard(self, stat_id: str, period: str):
        ...
        try:
            ...
            logging.error(f"Erro ao buscar a classificação de HG {period} para statId {stat_id}: {e}")
            self.leaderboard_data[period] = None
    ...
    async def create_leaderboard_page(self, start_index: int, is_ephemeral: bool):
        ...
        if leaderboard_data_for_period is None:
            embed = discord.Embed(
                title="Erro na Classificação de HG",
                description="Dados do placar de HG não estão disponíveis ou houve um erro na comunicação com a API. Por favor, tente novamente mais tarde.",
        ...
        if not leaderboard_data_for_period:
            ...
            embed = discord.Embed(
                title=f"Classificação de HG ({period_text}) - {current_stat_name}",
        ...
        if page_data:
            ...
            embed.description = "Não há jogadores nesta página ou no placar de HG."
        ...
        class LeaderboardView(discord.ui.View):
            ...
            def create_page_select(self):
                ...
                select = discord.ui.Select(
                    ...
                    options=options,
                    custom_id="page_select_hg", # ID customizado para este select
        ...
        class StatButton(discord.ui.Button):
            def __init__(self, parent_cog, stat_id: str, label: str, emoji: str, original_user_id: int, is_ephemeral_button: bool):
                super().__init__(
                    ...
                    emoji=emoji,
                    custom_id=f"stat_button_hg_{stat_id}", # ID customizado único para cada botão de estatística
                )
                self.parent_cog = parent_cog
        ...
        class SearchPlayerButton(discord.ui.Button):
            def __init__(self, parent_cog, original_user_id, is_ephemeral_button, original_interaction_for_edit):
                super().__init__(
                    ...
                    custom_id="search_player_hg", # ID customizado para este botão
                )
                self.parent_cog = parent_cog
                self.original_user_id = original_user_id
                self.is_ephemeral_button = is_ephemeral_button
            ...
            async def callback(self, interaction: discord.Interaction):
                ...
                class NickSearchModal(discord.ui.Modal, title="Pesquisar Jogador de HG"):
    ...
    @hg.command(name="total", description="Exibe a classificação total de Hunger Games.")
    async def total(self, interaction: discord.Interaction):
        """Comando para exibir o placar total de Hunger Games."""
        ...
        self.original_interaction_for_edit = interaction
        self.current_period = "total"
        self.current_stat_id = "19"
        ...
        if self.leaderboard_data.get(self.current_period) is None:
            await interaction.followup.send(
                "Erro ao buscar a classificação total de HG. Tente novamente mais tarde.",
                ephemeral=True,
            )
            return
    ...
    @hg.command(name="mensal", description="Exibe a classificação mensal de Hunger Games.")
    async def mensal(self, interaction: discord.Interaction):
        """Comando para exibir o placar mensal de Hunger Games."""
        should_be_ephemeral = False
        allowed_channels_cog = self.bot.get_cog("AllowedChannels")
        ...
        if self.leaderboard_data.get(self.current_period) is None:
            await interaction.followup.send(
                "Erro ao buscar a classificação mensal de HG. Tente novamente mais tarde.",
                ephemeral=True,
            )
            return
    ...
    @hg.command(name="semanal", description="Exibe a classificação semanal de Hunger Games.")
    async def semanal(self, interaction: discord.Interaction):
        """Comando para exibir o placar semanal de Hunger Games."""
        should_be_ephemeral = False
        allowed_channels_cog = self.bot.get_cog("AllowedChannels")
        ...
        if self.leaderboard_data.get(self.current_period) is None:
            await interaction.followup.send(
                "Erro ao buscar a classificação semanal de HG. Tente novamente mais tarde.",
                ephemeral=True,
            )
            return
...
async def setup(bot):
    ...
    await bot.add_cog(HGLeaderboards(bot))