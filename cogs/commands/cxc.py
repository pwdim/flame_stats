...
class Competitive(commands.Cog):
    ...
    def get_leaderboard(self):
        url = "https://api.flamemc.com.br/leaderboards?statId=30&size=200" # Assuming statId 30 for Competitive
    ...
    @app_commands.command(name="cxc", description="Veja as estatísticas de um jogador no ⚔️ Clan X Clan")
    @app_commands.describe(nick="Nome do jogador")
    async def competitive(self, interaction: discord.Interaction, nick: str):
        ...
        try:
            ...
            embed = discord.Embed(
                title=f"⚔️ Clan X Clan - {player_name}",
                color=discord.Color.dark_green()
            )
            embed.set_thumbnail(url=avatar_url)

            stat_keys = {
                "competitive_wins": "<a:wins:1348790119070564402> Vitórias ",
                "competitive_kills": "<a:abates:1348799859603406979> Abates ",
                "competitive_deaths": "<a:skull:1348799160979030096> Mortes ",
                "competitive_coins": "<a:coin:1348794160513024122> Coins ",
                "competitive_exp": "<a:xp:1348792513300795504> XP ",
            }

            exp = 0
            for stat in stats:
                if stat["statsMap"]["name"] == "competitive_exp":
                    exp = stat["value"]
                    break
